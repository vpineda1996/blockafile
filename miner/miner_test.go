...
func TestConfig(t *testing.T) {
	...
	t.Run("well-formed file with all fields", func(t *testing.T) {
		...
		equals(t, 8, mc.MinedCoinsPerOpBlock)
		equals(t, 4, mc.MinedCoinsPerNoOpBlock)
		equals(t, 4, mc.NumCoinsPerFileCreate)
		equals(t, 5, mc.GenOpBlockTimeout)
		equals(t, "83218ac34c1834c26781fe4bde918ee4", mc.GenesisBlockHash)
		equals(t, 4, mc.PowPerOpBlock)
		equals(t, 4, mc.PowPerNoOpBlock)
		equals(t, 2, mc.ConfirmsPerFileCreate)
		equals(t, 4, mc.ConfirmsPerFileAppend)
